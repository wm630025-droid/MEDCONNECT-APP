...
import 'package:medconnect_app/stay_in_loop.dart';
import 'package:medconnect_app/introScreen.dart';
import 'package:shared_preferences/shared_preferences.dart';

/// ============================================================
/// MedConnect - Onboarding Screen (Flutter port of the HTML mock)
/// Colors, spacing and layout values below map 1:1 to the
/// Tailwind config / inline styles used in the original HTML file.
/// NOTE: This uses the "Inter" font. Make sure it's added either
/// via the `google_fonts` package or bundled as an asset font in
/// pubspec.yaml, otherwise it will fall back to the platform font.
/// ============================================================
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  // Index of the active pagination dot (0-based). Starts on the
  // 2nd dot, exactly like the HTML markup (middle dot pre-active).
  int _activeDot = 1;
  ...
  void _onNext() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const OnboardingStayInLoopScreen()),
    );
  }
          ...
          child: Column(
            ...
            children: [
              ...
              ConstrainedBox(
                ...
                child: const Text(
                  'Access medical devices on flexible rental terms.',
                  textAlign: TextAlign.center,
